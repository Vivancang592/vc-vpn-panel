...
<div class="glass-card" style="padding: 1.75rem; width: 100%;">
    <form method="POST" action="/admin/servers/create" style="display: flex; flex-direction: column; gap: 1.25rem;">
        ...
        <div style="display: flex; justify-content: flex-end; margin-top: 0.5rem;">
            <button type="submit" class="glass-btn" style="padding: 0.65rem 1.75rem; font-size: 0.9rem;">➕ Tạo Máy Chủ</button>
        </div>
    </form>
</div>
