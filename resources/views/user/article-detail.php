        ...
        <?php if (!empty($relatedPosts)): ?>
            <div style="display: grid; gap: .7rem;">
                <?php foreach ($relatedPosts as $item): ?>
                    ...
                    <a href="/user/articles/detail?slug=<?= urlencode($itemSlug) ?>" style="display: grid; grid-template-columns: 86px minmax(0, 1fr); gap: .6rem; text-decoration: none; color: inherit; align-items: center;">
